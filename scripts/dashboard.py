...
from eeg import load_for_qdnu, list_available_subjects
from qdnu import TemplateTrainer, SeizurePredictor, PNDynamics
...
if __name__ == "__main__":
    ...
    output_path = create_dashboard(results, str(output_dir / 'qdnu_dashboard.png'))
